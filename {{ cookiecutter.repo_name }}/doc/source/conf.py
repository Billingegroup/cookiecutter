...
latex_documents = [
    ("index", "{{ cookiecutter.project_name }}.tex", "{{ cookiecutter.project_name }} Documentation", "manual"),
]
...
man_pages = [("index", "{{ cookiecutter.project_name }}", "{{ cookiecutter.project_name }} Documentation",  1)]
